...
INTENT_LEXICON: Dict[str, Dict[str, List[str]]] = {
    ...
    "LOAN_COST_INQUIRY": {
        "english": [
            "how much interest would be charged",
            "how much interest would be charged on",
            "how much interest will be charged",
            "how much interest",
            "interest charged on loan",
            "what interest would i pay",
            "what would i pay",
            "exact amount",
            "exact interest",
            "exact emi",
        ...
        "hinglish": [
            "kitna byaaj lagega",
            "byaaj kitna hoga",
            "exact amount kitna hai",
            "exact amount",
            "exact interest kitna hoga",
            "loan par kitna interest lagega",
            "interest kitna charge hoga",
            "emi kitni banegi",
            "kitna bharna padega",
            "kitna dena hoga",
            "total repayment kitna hoga",
            "interest kitna hai",
        ],
    },
